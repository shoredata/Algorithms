...
// In this famous mathematical sequence, each number is the sum of the previous 
// two, starting with values 0 and 1.
...
//   fibonacci(6) = 8 (3+5),
//   fibonacci(7) = 13 (5+8).
// Do this without using recursion first.  If you don't know what a recursion is 
// yet, don't worry as we'll be introducing this concept in Part 2 of this assignment.
